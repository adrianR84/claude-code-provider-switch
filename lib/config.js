...
${ENV_VARS.OPENROUTER_MODEL}=${DEFAULT_MODELS.OPENROUTER}
${ENV_VARS.ANTHROPIC_MODEL}=${DEFAULT_MODELS.ANTHROPIC}
${ENV_VARS.MINIMAX_MODEL}=${DEFAULT_MODELS.MINIMAX}
${ENV_VARS.OLLAMA_MODEL}=${DEFAULT_MODELS.OLLAMA}

# Default provider and model settings
${ENV_VARS.DEFAULT_PROVIDER}=default
${ENV_VARS.DEFAULT_MODEL}=

# Claude Code settings
${ENV_VARS.CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC}=${DEFAULT_VALUES.CLAUDE_CODE_DISABLE_NONESSENTIAL_TRAFFIC}
`;
