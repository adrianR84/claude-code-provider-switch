...
const PROVIDERS = {
  ...
  proxy: {
    ...
    authHeader: "Bearer",
    defaultModel: "gpt-4o",
    envVars: { auth: "PROXY_AUTH_TOKEN", model: "PROXY_MODEL" },
    aliases: ["proxy", "pr", "litellm"],
  },
  original: {
...
const FILE_PATHS = {
  claudeDir,
  scriptPath,
  globalEnvFile: path.join(claudeDir, ".claude-switch-env"),
  localEnvFile: path.join(scriptPath, ".claude-switch-env-local"),
};
