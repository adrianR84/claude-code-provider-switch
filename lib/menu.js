...
function showProviderMenu() {
  ...
  const providers = [
    { id: 'openrouter', name: 'OpenRouter', aliases: ['openrouter', 'or', 'open'] },
    { id: 'ollama', name: 'Ollama', aliases: ['ollama', 'oll'] },
    { id: 'anthropic', name: 'Anthropic', aliases: ['anthropic', 'ant'] },
    { id: 'default', name: 'Default Claude Code', aliases: ['default', 'def', 'd'] },
  ...
  function displayMenu() {
    ...
    providers.forEach((provider, index) => {
      ...
      const aliases = 
        provider.aliases.length > 0 ? ` Aliases: (${provider.aliases.join(', ')})` : '';
      log(
