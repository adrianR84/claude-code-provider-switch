...
const { ENV_VARS, PROVIDER_ALIASES } = require("./constants");
const {
  ...
  const providers = [
    {
      id: "openrouter",
      name: "OpenRouter",
      aliases: PROVIDER_ALIASES.openrouter,
    },
    {
      id: "ollama",
      name: "Ollama",
      aliases: PROVIDER_ALIASES.ollama,
    },
    {
      id: "anthropic",
      name: "Anthropic",
      aliases: PROVIDER_ALIASES.anthropic,
    },
    {
      id: "minimax",
      name: "Minimax",
      aliases: PROVIDER_ALIASES.minimax,
    },
    {
      id: "original",
      name: "Original Claude Code",
      aliases: PROVIDER_ALIASES.original,
    },
