...
function showUsage() {
  ...
  log("       claude-switch ui - Display interactive menu", "reset");
  log("", "reset");
  log("Providers:", "reset");
  ...
  log("Options:", "reset");
  log(
    "  ui                 - Show interactive provider selection menu",
    "reset",
  );
  ...
  log("", "reset");
  log(
    "Run without arguments to use default provider (if set) or show this help message.",
    "reset",
  );
  log("", "reset");
}
