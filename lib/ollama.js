...
const { log, loadEnvFile } = require("./config");
    ...
    const req = https.request(options, (res) => {
      ...
      res.on("end", () => {
        try {
          ...
          const models = response.data || response; // Handle both data and direct array
...
async function showModelSelection() {
  ...
  console.log("Debug: envVars object keys:", Object.keys(envVars));
  console.log("Debug: envVars.envFile:", envVars.envFile);
  const authToken = envVars && envVars.OLLAMA_AUTH_TOKEN;
